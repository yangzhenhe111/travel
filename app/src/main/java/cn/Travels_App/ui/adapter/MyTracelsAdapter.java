...
public class MyTracelsAdapter extends ArrayAdapter<Travels> {
    //资源id
    ...
    public MyTracelsAdapter(Context context, int textViewResourceId, List<Travels> objects){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        View view;
        MyTracelsAdapter.ViewHolder viewHolder;
        if (convertView==null){
            ...
            viewHolder=new MyTracelsAdapter.ViewHolder();
            ...
            view=convertView;
            viewHolder=(MyTracelsAdapter.ViewHolder) view.getTag();
        }

...
public class FlowAutoRadioGroup extends RadioGroup {

    public FlowAutoRadioGroup(Context context) {
        super(context);
    }

    public FlowAutoRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
